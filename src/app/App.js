                ...
                {user && (
                    <div id="main-container">
                        ...
                        <Route
                            path="/findpeople"
                            render={(props) => (
                                <FindPeople history={props.history} />
                            )}
                        />
                        ...
                        <Route
                            path="/users-online"
                            render={(props) => (
                                <UsersOnline history={props.history} />
                            )}
                        />
                        ...
                        <Route
                            ...
                            path="/forums"
                            render={(props) => (
                                <ForumsDashboard history={props.history} />
                            )}
                        />

                        <Route
                            exact
                            path="/forums/:forumId/page-:forumPage"
                            render={(props) => (
                                <Forum
                                    key={props.match.url}
                                    match={props.match}
                        ...
                        <Route
                            exact
                            path="/forums/:forumId/new-thread"
                            render={(props) => (
                                <NewThread
                                    key={props.match.url}
                                    match={props.match}
